...
(def pages
  [{:page/title     "Home"
    :page/component components/home-post
    :page/key       ::home}
   {:page/title     "Projects"
    :page/component components/project-listing
    :page/key       ::projects}
   {:page/title     "My story"
    :page/component components/my-story
    :page/key       ::my-story}
   {:page/title     "Contact"
    :page/component components/contact-me
    :page/key       ::contact-me}])

(def state
  {:projects (take 7 (cycle  [{:project/id          7
...
<p>View the full project which includes my process and conceptualisation on <a href='https://behance.net/gallery/58062741/zoetic-soaps.</p>'>Behance</a></p>"
   ...
   :featured-project {:project/id          2
                      :project/title       "Leather book"
                      :project/image       "leather_book.jpg"
                      :project/description (util/random-str 5)}
   :pages pages})
     ...
     [:.container
      [:.content
       ...
       [:section.section.container-page
        (for [{:page/keys [title component key]} (:pages db)
              :let [active? (= page key)]]
